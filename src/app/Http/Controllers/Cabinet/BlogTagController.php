...
class BlogTagController extends Controller
{
    ...
    public function index(): View
    {
        ...
        return view('cabinet.blog_tags.index', compact('tags'));
    }
    ...
    {
        return view('cabinet.blog_tags.create');
    }
    ...
    public function store(BlogTagRequest $request): RedirectResponse
    {
        ...
        return redirect()->route('cabinet.blog_tags.index');
    }
    ...
    public function edit(string $id): View
    {
        ...
        return view('cabinet.blog_tags.edit', compact('tag'));
    }
