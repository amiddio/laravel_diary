...
use App\Repositories\Cabinet\DiaryPostRepository;
...
class DiaryPostController extends Controller
{
    ...
    public function index(): View
    {
        ...
        return view('cabinet.diary_posts.index', compact('posts'));
    }
    ...
    {
        return view('cabinet.diary_posts.create');
    }
    ...
    public function store(DiaryPostRequest $request): RedirectResponse
    {
        ...
        return redirect()->route('cabinet.diary_posts.index');
    }
    ...
    public function show(string $id): View
    {
        ...
        return view('cabinet.diary_posts.show', compact('post'));
    }
    ...
    public function edit(string $id): View
    {
        ...
        return view('cabinet.diary_posts.edit', compact('post'));
    }
