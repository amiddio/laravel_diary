    ...
    <x-slot name="content">
        <x-card-general>
            ...
            <x-links-head>
                ...
                <a href="{{ route('cabinet.blog_posts.index') }}" class="btn btn-link">{{ __('Post List') }}</a>
                <a href="{{ route('cabinet.blog_posts.create') }}" class="btn btn-link">{{ __('Add Post') }}</a>
                <a href="{{ route('cabinet.blog_posts.show', $post->id) }}" class="btn btn-link">{{ __('Show Post') }}</a>
                <a href="{{ route('cabinet.blog_tags.index') }}" class="btn btn-link">{{ __('Manage Tags') }}</a>
            </x-links-head>

            <div>
                <form method="post" action="{{ route('cabinet.blog_posts.update', $post->id) }}">
                    @csrf
                    @method('put')
